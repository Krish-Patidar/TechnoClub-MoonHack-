  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto link_group">
      <li class="nav-item active">
       ...
       <li class="nav-item active">
        <a class="nav-link link_item" href="myClubs.jsp">My Clubs</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link link_item" href="aicredit.jsp">AI Credit System</a>
      </li>
    </ul>
   <form class="form-inline my-2 my-lg-0">
  <button class="btnn btn" type="button" data-toggle="tooltip" data-placement="bottom" title="Profile" onclick="window.location.href='studentprofile.jsp'">
...
<form class="form-inline my-2 my-lg-0">
  <button class="btn signup" type="button" onclick="window.location.href='StudentLogout'">Log Out</button>
</form>
