...
<head>
    ...
    <title>Medicaps Student LogIn</title>
</head>
    ...
    <div class="box">
      <div class="inner-box">
        <div class="forms-wrap">
          <form action="StudentLogin" method="post" class="sign-in-form form">
            <div class="logo">
            </div>
            ...
            <div class="heading">
             ...
             <h1 class="manager-name">Medicaps Student
                                      </h1>
...
<br>
        ...
        <div class="carousel">
          <div class="images-wrapper">
            <img src="./image/medicpas.jpg" class="image img-1 show" alt="" />
            <img src="./image/medicpas.jpg" class="image img-2" alt="" />
            <img src="./image/medicpas.jpg" class="image img-3" alt="" />
          </div>
